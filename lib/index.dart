...
class _IndexPageState extends State<IndexPage> {
  final List<BottomNavigationBarItem> bottomTabList = [
    ...
    BottomNavigationBarItem(icon: Icon(Icons.queue_play_next), title: Text("服药")),
    BottomNavigationBarItem(icon: Icon(Icons.healing), title: Text("健康")),
    BottomNavigationBarItem(icon: Icon(Icons.person), title: Text("我的"))
  ];
  final List bodyList = [HomePage(), MedicalPage(), HealthPage(), MinePage()];
